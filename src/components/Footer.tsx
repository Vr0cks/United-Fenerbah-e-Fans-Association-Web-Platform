    ...
    <footer className="bg-[#02060b] text-white pt-24 pb-12 border-t border-white/5 relative overflow-hidden font-light">
      ...
      <div className="max-container padding-container relative z-10">
           ...
           {/* 2. KOLON: KURUMSAL */}
            <FadeIn delay={0.2}>
                ...
                <ul className="flex flex-col gap-4 text-gray-400 text-sm">
                    {/* LİNKLERİ GÜNCELLEDİK */}
                    <FooterLink href="/hakkimizda">Hakkımızda</FooterLink>
                    {/* Yönetim kurulu anasayfada olduğu için anchor link (#leadership) verebiliriz veya ayrı sayfa yapabiliriz. Şimdilik anasayfaya atalım */}
            ...
            {/* 4. KOLON: İLETİŞİM (Ankara Adresi) */}
            <FadeIn delay={0.4}>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-gray-500">
            ...
            {/* SENİN İMZAN :) */}
            <p className="opacity-50 hover:opacity-100 transition-opacity cursor-default">
                Designed & Developed by <span className="text-[#f1c40f]">vr0cks</span>
            </p>
        </div>
